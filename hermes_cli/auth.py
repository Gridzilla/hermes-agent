...
PROVIDER_REGISTRY: Dict[str, ProviderConfig] = {
    ...
    "neuralwatt": ProviderConfig(
        id="neuralwatt",
        name="Neuralwatt",
        auth_type="api_key",
        inference_base_url="https://api.neuralwatt.com/v1",
        api_key_env_vars=("NEURALWATT_API_KEY",),
        base_url_env_var="NEURALWATT_BASE_URL",
    ),
    "wafer": ProviderConfig(
        id="wafer",
        name="Wafer AI",
        auth_type="api_key",
        inference_base_url="https://pass.wafer.ai/v1",
        api_key_env_vars=("WAFER_API_KEY",),
...
def resolve_provider(
    ...
    *,
    ...
    _PROVIDER_ALIASES = {
        ...
        "neural-watt": "neuralwatt", "neuralwatt-ai": "neuralwatt",
        "wafer-ai": "wafer", "waferai": "wafer",
