...
def _build_apikey_providers_list() -> list:
    ...
    _static = [
        ...
        ("Neuralwatt",       ("NEURALWATT_API_KEY",),                        "https://api.neuralwatt.com/v1/models", "NEURALWATT_BASE_URL", True),
        ("Wafer AI",         ("WAFER_API_KEY",),                             "https://pass.wafer.ai/v1/models", "WAFER_BASE_URL", True),
    ...
    _name_to_canonical = {
        ...
        "Arcee AI": "arcee", "GMI Cloud": "gmi", "Neuralwatt": "neuralwatt", "Wafer AI": "wafer", "DeepSeek": "deepseek",
